...
export class News extends Component {
  constructor() {
    ...
    async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=6168a2b45eca45a7b7c06f7b39bb38ab&page=1&pageSize=${this.state.pageSize}`;
    ...
    handlePrevClick = async()=>{
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=6168a2b45eca45a7b7c06f7b39bb38ab&page=${this.state.page - 1}&pageSize=${this.state.pageSize}`;
      let data = await fetch(url);
      let parsedData = await data.json();
      console.log(parsedData);
      this.setState({
    ...
    return (
      <div className='container my-3'>
        ...
        <div className="container d-flex justify-content-center">
          ...
          <button disabled={this.state.page >= maxPage} type="button" className="btn btn-primary mx-2" onClick={this.handleNextClick}>Next &rarr;</button>
        </div>
      </div>
    )
  }
